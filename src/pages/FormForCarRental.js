      ...
      <div id="page-wrapper">
        <div className="row">
          <div className="col-lg-12">
            <h1 className="page-header">Hotel Data Panel</h1>
          </div>
          {/* <!-- /.col-lg-12 --> */}
        </div>
        {/* <!-- /.row --> */}
                  ...
                  <div className="col-lg-6">
                    <form role="form">
                     {/*<div className="form-group">
                      ...
                      <div className="form-group">
                        <label>ID City</label>
                        <input className="form-control" placeholder="ex: 00000000001" />
                      </div>
                      <div className="form-group">
                        <label>Name</label>
                        <input className="form-control" placeholder="ex: Hendra" />
                      </div>
                      <div className="form-group">
                        <label>Image</label>
                        <input type="file" />
                     ...
                     {/* 
                      ...
                      <button type="submit" className="btn btn-default">Submit Button</button> <button type="reset" className="btn btn-default">Reset Button</button>
                    </form>
                  </div>
                  {/* <!-- /.col-lg-6 (nested) --> */}
                  {/*
