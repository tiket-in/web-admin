  ...
  render() {
    return (
        ...
        <div className="navbar-header">
          ...
          <a className="navbar-brand" href="/">Welcome to Admin Panel Tiketin.com</a>
        </div>
        {/* <!-- /.navbar-header --> */}
        ...
        <div className="navbar-default sidebar" role="navigation">
          <div className="sidebar-nav navbar-collapse">
            <ul className="nav" id="side-menu">
              ...
              <li>
                <a href="/forms"><i className="fa fa-edit fa-fw"></i> Form Flight</a>
              </li>
              <li>
                <a href="/formforcarrental"><i className="fa fa-edit fa-fw"></i> Form Hotel</a>
              </li>
              <li>
                <a href="/forms"><i className="fa fa-edit fa-fw"></i> Form Train</a>
              </li>
              <li>
                <a href="/forms"><i className="fa fa-edit fa-fw"></i> Form Car Rental</a>
              </li>
              <li>
                <a href="/forms"><i className="fa fa-edit fa-fw"></i> Form Atraksi</a>
              </li>
              <li>
                <a href="/forms"><i className="fa fa-edit fa-fw"></i> Form Event</a>
              </li>
              <li>
